...
def get_argparser():
    ...
    parser.add_argument("--py-path", default=".",                                       help="Path to a python virtual environment for running EMOD")
    ...
    parser.add_argument("--timing", action='store_true', default=False,                 help="Log simulation duration")
    parser.add_argument('--hidegraphs', action='store_true', default=False,             help="Unused; retained for Jenkins")
