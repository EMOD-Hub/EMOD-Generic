...
Similar to Environmental\SFTs\Multi_Route_HINT\Single_Property_Within_Group, this SFT is testing multiple routes HINT 
transmission within the same IP group. This SFT tests more IP values(10) and larger HINT matrix range. Please see test 
comment in Environmental\SFTs\Multi_Route_HINT\Single_Property_Within_Group for more details.

This test validates 6 things:
...
5. InsetChart New Infections for each route should equal to the sum of all new infections for that route across all groups
6. Total contagion population from InsetChart should be euqal to the sum of total contagion population across all groups
