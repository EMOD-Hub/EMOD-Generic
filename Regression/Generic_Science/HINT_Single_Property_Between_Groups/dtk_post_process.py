...
"""
This SFT tests single property Heterogeneous Intranode Transmission between different property groups.

Outbreak intervention is delivered to Seed_1 and Seed_2 groups at time step 0 with coverrage = 1.
