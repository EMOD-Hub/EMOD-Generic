...
namespace Kernel
{
    ...
    bool StiRelationshipStartReporter::Configure( const Configuration* inputJson )
    {
        ...
        initConfigTypeMap( "Report_Relationship_Start_Individual_Properties", &properties_to_report, Report_Relationship_Start_Individual_Properties_DESC_TEXT, "Report_Relationship_Start" );
    ...
    {
        keys_to_report = ReportUtilities::GetKeys( properties_to_report, "Report_Relationship_Start_Individual_Properties" );
    ...
    void StiRelationshipStartReporter::onNewRelationship(IRelationship* relationship)
    {
        ...
        if (male_partner && female_partner)
        {
            ...
            info.participant_a.props                             = *(individual->GetProperties()) ;
            ...
            info.participant_b.props                             = *(individual->GetProperties());
    ...
    std::string StiRelationshipStartReporter::GetHeader() const
    {
        ...
        header
            ...
            << "," << "A_is_superspreader"
                   << ReportUtilities::GetIPColumnHeader( "A_", properties_to_report )
            << "," << "B_ID"
            << "," << "B_is_infected"
            << "," << "B_gender"
            << "," << "B_age"
        ...
        header
            ...
            << "," << "B_is_superspreader"
                   << ReportUtilities::GetIPColumnHeader( "B_", properties_to_report );
        return header.str();
    }
        ...
        for (auto& entry : report_data)
        {
            ...
            GetOutputStream() << "," << entry.participant_a.cumulative_lifetime_relationships
                              ...
                              << "," << entry.participant_a.is_superspreader
                                     << ReportUtilities::GetIPData( entry.participant_a.props, keys_to_report )
