...
reporting. See [software-outputs](../md_software/software-outputs.md) for more information about the different output reports available.
...
See [software-custom-reporter](../md_software/software-custom-reporter.md) for information about how to use a custom reporter.
