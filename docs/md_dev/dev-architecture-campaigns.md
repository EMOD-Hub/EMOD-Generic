...
![Campaign Architecture](../figures/dev/ArchCampaignManagement.png)
...
For more information on setting up campaign files, see [model-campaign](../md_model/model-campaign.md).
...
![EMOD campaign architecture](../figures/dev/ArchCampaignFlow.png)
