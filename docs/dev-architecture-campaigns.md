...
![images/dev/ArchCampaignManagement.png](images/dev/ArchCampaignManagement.png)
...
For more information on setting up campaign files, see [model-campaign](model-campaign.md).
