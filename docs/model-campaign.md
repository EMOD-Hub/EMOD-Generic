...
organized into logical groups of parameters that can have arbitrary levels of nesting. It contains
...
![images/general/howto-multiple.png](images/general/howto-multiple.png)
...
existing campaign file and modify it to meet your needs. The simplest method is to edit the
parameters or parameter values in the JSON file in any text editor. You may also create or modify
the files using a scripting language, as with configuration files. See [software-configuration-script](software-configuration-script.md)
...
more detail about the campaign file structure, see [parameter-campaign](parameter-campaign.md). For more information about JSON, see [parameter-overview](parameter-overview.md).
