...
![Multiple Interventions](../figures/general/howto-multiple.png)
...
into a single file before running a simulation. See [software-campaign-overlay](../md_software/software-campaign-overlay.md) for more information
...
the files using a scripting language, as with configuration files. See [software-configuration-script](../md_software/software-configuration-script.md)
