...
individuals with different property values. For more information, see [model-hint](model-hint.md).
...
[parameter-configuration-infectivity](../md_parameter/parameter-configuration-infectivity.md) for more information.
...
same process to assign properties to a **node**. To see all individual and node property parameters, see [NodeProperties and IndividualProperties](../md_parameter/parameter-demographics.md#nodeproperties-and-individualproperties).
...
demographics file. See [parameter-demographics](../md_parameter/parameter-demographics.md) for a list of supported properties. The values
...
```
{% include "json/howto-demographics-groups.json" %}
```
