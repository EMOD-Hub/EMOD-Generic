...
![Flowchart](../figures/general/GenericModel_Flowchart.png)
...
handled via several **JSON (JavaScript Object Notation)** files. For more information, see [software-overview](../md_software/software-overview.md).
