...
accurately referred to as a **simulation type**. For more information on the software architecture and inheritance, see [software-overview](../md_software/software-overview.md).
