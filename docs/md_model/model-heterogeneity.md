...
For more information on the demographics file, see [software-demographics](../md_software/software-demographics.md).
...
Similarly, you can add properties to **nodes** in a simulation. For example, you might configure
some regions to be more urban or rural, to have better health care, or to be difficult to access by
health care workers. This feature of EMOD is known as Heterogeneous Intra-Node Transmission (HINT); for more information, see
[model-hint](model-hint.md).

## Transmission

By default, EMOD assumes transmission is homogeneous in each node: transmission does not vary
...
Other EMOD simulation types capture heterogeneous transmission through more biologically
