...
![SI - SIS model](../figures/general/SI-SIS.png)
...
![Figure 1: SI outbreak showing logistic grown](../figures/general/SI_InsetChart_vitaloff.png)

![Figure 2: All output channels for an SI outbreak](../figures/general/SI_AllCharts_vitaloff.png)

### SI with vital dynamics

To add vital dynamics to a population, let $\mu$ and $\nu$ represent the birth and death rates, respectively, for the model. To maintain a
constant population, assume that $\mu = \nu$. Therefore, the ODE becomes:
...
![Figure 3: SI outbreak approaching 85% infected population at steady state](../figures/general/SI_InsetChart_default.png)

![Figure 4: All output channels for an SI outbreak with vital dynamics](../figures/general/SI_AllCharts_default.png)
...
information, see [parameter-configuration-incubation](../md_parameter/parameter-configuration-incubation.md) and [parameter-configuration-immunity](../md_parameter/parameter-configuration-immunity.md) parameters.
...
![Figure 5: SIS outbreak approaching 17% infected population at steady state](../figures/general/SIS_InsetChart_default.png)

![Figure 6: All output channels for an SIS outbreak without vital dynamics](../figures/general/SIS_AllCharts_default.png)
