...
![SEIR - SEIRS model](../figures/general/SEIR-SEIRS.png)
...
[parameter-configuration-incubation](../md_parameter/parameter-configuration-incubation.md) parameters.
...
is shorter but that the cumulative infections remains the same.

![Figure 1: SEIR epidemic course for 8-day incubation period](../figures/general/SEIR_InsetChart_default.png)

![Figure 2: All output channels for SEIR 8-day incubation period](../figures/general/SEIR_AllCharts_default.png)

![Figure 3: SEIR epidemic course for 2-day incubation period](../figures/general/SEIR_InsetChart_2day.png)

![Figure 4: All output channels for SEIR 2-day incubation period](../figures/general/SEIR_AllCharts_2day.png)
...
![Figure 5: SEIR periodic outbreaks on reintroduction in a population with vital dynamics](../figures/general/SEIR_Vital_InsetChart_default.png)

![Figure 6: All output channels for SEIR outbreaks](../figures/general/SEIR_Vital_AllCharts_default.png)
...
outbreak after day 500. For more information on creating campaigns, see [model-campaign](model-campaign.md).

![Figure 7: Trajectory of the SEIRS outbreak](../figures/general/SEIRS_InsetChart_default.png)

![Figure 8: All output channels for SEIRS outbreak](../figures/general/SEIRS_AllCharts_default.png)
