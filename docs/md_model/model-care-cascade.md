...
property in the demographics file (see [NodeProperties and IndividualProperties](../md_parameter/parameter-demographics.md#nodeproperties-and-individualproperties) for more information). In the
...
target the desired individuals. See [model-targeted-interventions](../md_model/model-targeted-interventions.md) for more information on targeting interventions and [parameter-campaign-event-coordinators](../md_parameter/parameter-campaign-event-coordinators.md) for all available
event coordinators.
