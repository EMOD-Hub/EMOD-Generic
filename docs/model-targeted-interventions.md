...
first define those properties in the **demographics file** using **IndividualProperties** or **NodeProperties**. See [demo-properties](#demo-properties) parameters for more information. Then, in the **event coordinator** in the campaign file, you can target an intervention or outbreak to
...
![images/general/howto-targeted-1.png](images/general/howto-targeted-1.png)
...
![images/general/howto-targeted-2.png](images/general/howto-targeted-2.png)
...
![images/general/howto-targeted-3.png](images/general/howto-targeted-3.png)
...
![images/general/howto-targeted-4.png](images/general/howto-targeted-4.png)
...
![images/general/howto-targeted-5.png](images/general/howto-targeted-5.png)
...
![images/general/howto-targeted-6.png](images/general/howto-targeted-6.png)
...
the downloadable [EMOD scenarios](https://github.com/InstituteforDiseaseModeling/docs-emod-scenarios/releases) zip file. Review the README files there for more information.
