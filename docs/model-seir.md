...
![SEIR - SEIRS model](images/general/SEIR-SEIRS.png)
...
$\sigma$, is the rate of latent individuals becoming infectious (average duration of incubation is 1/$\sigma$). Recovery rate, $\gamma$ = 1/D, is determined by the average duration, D, of infection. For the SEIRS model, $\xi$ is the rate which recovered individuals return to the
...
[parameter-configuration-incubation](parameter-configuration-incubation.md) parameters.
...
However, since the model does not include mortality, the basic **reproductive number**, R~0~  = $\beta/\gamma$, does not change.
...
The following graphs show the **inset chart** and charts for all channels in a couple typical
...
the Generic/SEIR scenario in the downloadable [EMOD scenarios](https://github.com/InstituteforDiseaseModeling/docs-emod-scenarios/releases) zip file. Review the README files there for more
information.

![Figure 1: SEIR epidemic course for 8-day incubation period](images/general/SEIR_InsetChart_default.png)

*Figure 1: SEIR epidemic course for 8-day incubation period*

![Figure 2: All output channels for SEIR 8-day incubation period](images/general/SEIR_AllCharts_default.png)

*Figure 2: All output channels for SEIR 8-day incubation period*

![Figure 3: SEIR epidemic course for 2-day incubation period](images/general/SEIR_InsetChart_2day.png)

*Figure 3: SEIR epidemic course for 2-day incubation period*

![Figure 4: All output channels for SEIR 2-day incubation period](images/general/SEIR_AllCharts_2day.png)
...
population like this, disease dynamics will reach a steady state. Where $\mu$ and $\nu$
...
dynamics. To run this example simulation, see the Generic/SEIR_VitalDynamics scenario in the [EMOD scenarios](https://github.com/InstituteforDiseaseModeling/docs-emod-scenarios/releases) folder.
Review the README files there for more information.

![Figure 5: SEIR periodic outbreaks on reintroduction in a population with vital dynamics](images/general/SEIR_Vital_InsetChart_default.png)

*Figure 5: SEIR periodic outbreaks on reintroduction in a population with vital dynamics*

![Figure 6: All output channels for SEIR outbreaks](images/general/SEIR_Vital_AllCharts_default.png)

*Figure 6: All output channels for SEIR outbreaks*

## SEIRS model

The **SEIR model** assumes people carry lifelong immunity to a disease upon recovery, but for many diseases the immunity after infection wanes over time. In this case, the SEIRS model is used to allow recovered individuals to return to a susceptible state. Specifically, $\xi$ is the rate which recovered
...
For more information, see [parameter-configuration-immunity](parameter-configuration-immunity.md) parameters.
...
[EMOD scenarios](https://github.com/InstituteforDiseaseModeling/docs-emod-scenarios/releases) zip file. Review the README files there  for more information. For more information on creating campaigns, see [model-campaign](model-campaign.md).

![Figure 7: Trajectory of the SEIRS outbreak](images/general/SEIRS_InsetChart_default.png)

*Figure 7: Trajectory of the SEIRS outbreak*

![Figure 8: All output channels for SEIRS outbreak](images/general/SEIRS_AllCharts_default.png)
