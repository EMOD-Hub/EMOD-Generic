...
1. Review the output and examine any failures.
    ...
    any simulation (see [software-error-logging](software-error-logging.md)). In addition, regression_test.py will output time.txt
...
![images/dev/matplotlibPopupChart.png](images/dev/matplotlibPopupChart.png)
