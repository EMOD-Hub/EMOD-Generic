...
1. Generate a single config.json file from a base file and the parameter_overrides.json that contains (see [software-configuration-overlay](software-configuration-overlay.md) for instructions). 
