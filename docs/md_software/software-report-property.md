...
The property output report is a JSON-formatted file with the **channel** output results of the
simulation, defined by the groups set up using **IndividualProperties** in the demographics file.
See [NodeProperties and IndividualProperties](../md_parameter/parameter-demographics.md#nodeproperties-and-individualproperties) for more information. For example, it allows you to compare disease deaths
