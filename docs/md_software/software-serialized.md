...
from  **stochastic** noise). This is known as steady state. The simulation output prior to that point is disregarded.  This is a modeling concept known as **simulation burn-in**, borrowed from
...
See [parameter-configuration-setup](../md_parameter/parameter-configuration-setup.md) parameters for more information.
