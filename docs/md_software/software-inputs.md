...
read and edit. For more information about JSON, see  [parameter-overview](../md_parameter/parameter-overview.md). Some of the inputs
...
**demographics file**     Defines the geography and the population being modeled. Each geographic **node** has a location,
...
**stochastic**, it requires running many simulations which may require a lot of processing
...
the world for download on GitHub. For instructions, see [install-overview](../md_install/install-overview.md).  Some input files
...
simulation. See [parameter-demographics](../md_parameter/parameter-demographics.md) for more information about **NodeID** generation.
