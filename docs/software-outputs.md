...
![images/intro/output.png](images/intro/output.png)
...
built-in reports that you can produce if you enable them in the **configuration file** with the [parameter-configuration-output](parameter-configuration-output.md) parameters. Reports are generally in JSON or CSV format.
