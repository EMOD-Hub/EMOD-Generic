...
- [dev-architecture-core](dev-architecture-core.md)
- [dev-architecture-campaigns](dev-architecture-campaigns.md)
- [dev-architecture-reporter](dev-architecture-reporter.md)
