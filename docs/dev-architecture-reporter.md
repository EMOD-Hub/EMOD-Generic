...
reporting. See [software-outputs](software-outputs.md) for more information about the different output reports available.
...
See [software-custom-reporter](software-custom-reporter.md) for information about how to use a custom reporter.
