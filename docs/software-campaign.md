...
[model-campaign](model-campaign.md) describes some ways to configure a campaign file to target individuals with particular characteristics, repeat interventions, and more. See [parameter-campaign](parameter-campaign.md) for a
