...
disease transmission within a node by enabling and configuring the **Heterogeneous Intra-Node Transmission (HINT)** feature. For more information, see [model-hint](model-hint.md).
...
[software-load-balancing](software-load-balancing.md) for more information.
...
[parameter-configuration-sampling](parameter-configuration-sampling.md) for more information.
