...
```json
{% include "json/demographics-skeletal.json" %}
```
...
that assign properties to individuals in a simulation. [model-properties](model-properties.md) provides more guidance.
