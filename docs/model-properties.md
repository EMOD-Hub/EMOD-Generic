...
same process to assign properties to a **node**. To see all individual and node property parameters, see [demo-properties](#demo-properties).
...
[demographics file](https://github.com/InstituteforDiseaseModeling/EMOD-InputData/blob/master/SamplesInput/hint_ageandaccess_overlay.json) used in the 11_HINT_AgeAndAccess scenario. This scenario is described in more detail in [model-hint](model-hint.md).
