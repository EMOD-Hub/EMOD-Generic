...
be **JSON (JavaScript Object Notation)** files, which are preferred, or binary files.
...
$i^{th}$ entry in the series is equal to the cumulative proportion of the processing load for all the previous nodes 0 through $i$.
...
![images/file-structure/loadbalancingBFF.jpg](images/file-structure/loadbalancingBFF.jpg)
