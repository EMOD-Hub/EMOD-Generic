...
std::map< int, Kernel::IndividualHumanEnvironmental * > population;
...
static Kernel::IndividualHumanEnvironmental* initInd( int sex, float age, float mcw )
{
    person = Kernel::IndividualHumanEnvironmental::CreateHuman( &node, (*individualHumanSuidGenerator)(), mcw, age, sex );
    if( configStubJson == nullptr )
    {
        //configStubJson = Configuration::Load("gi.json");
        setConfigJson();
    ...
    class Simulation
    {
        public:
            ...
            Simulation()
            {
                ...
                Kernel::IndividualHumanConfig adam; // Environmental doesn't have anything to configure
...
static PyMethodDef EnvironmentalIndividualMethods[] =
{
     ...
     {"should_infect", shouldInfect<Kernel::IndividualHumanEnvironmental>, METH_VARARGS, "Ask intrahost module if transmission should occur."},
     {"give_intervention", giveIntervention, METH_VARARGS, "Invoke pointer by calling instantiating function."},
     {"get_individual_for_iv", getIndividual<Kernel::IndividualHumanEnvironmental>, METH_VARARGS, "Get PyCapsule pointer to pass to intervention."},
...
static struct PyModuleDef moduledef = {
    ...
    "dtk_environmental_intrahost",
    nullptr,
    0,
    EnvironmentalIndividualMethods,
    nullptr,
    nullptr,
    nullptr,
    nullptr
...
PyMODINIT_FUNC
PyInit_dtk_environmental_intrahost(void)
{
