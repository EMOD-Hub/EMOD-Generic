...
Kernel::IndividualHumanSTI * person = nullptr;
...
std::map< int, Kernel::IndividualHumanSTI * > population;
...
static Kernel::IndividualHumanSTI* initInd( int sex, float age, float mcw )
{
    person = Kernel::IndividualHumanSTI::CreateHuman( &node, (*individualHumanSuidGenerator)(), mcw, age, sex );
    if( configStubJson == nullptr )
    {
        //configStubJson = Configuration::Load("gi.json");
        setConfigJson();
    ...
    class Simulation
    {
        public:
            ...
            Simulation()
            {
                ...
                Kernel::IndividualHumanConfig adam; // STI doesn't have anything to configure
...
static PyMethodDef STIIndividualMethods[] =
{
