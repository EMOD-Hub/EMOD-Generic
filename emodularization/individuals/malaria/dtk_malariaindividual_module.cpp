...
std::map< int, Kernel::IndividualHumanMalaria * > population;
...
static Kernel::IndividualHumanMalaria* initInd( int sex, float age, float mcw )
{
    person = Kernel::IndividualHumanMalaria::CreateHuman( &node, (*individualHumanSuidGenerator)(), mcw, age, sex );
    if( configStubJson == nullptr )
    {
        //configStubJson = Configuration::Load("gi.json");
        setConfigJson();
    ...
    class Simulation
    {
        public:
            ...
            Simulation()
            {
                ...
                Kernel::IndividualHumanMalariaConfig adamMal; // Malaria doesn't have anything to configure
                adamMal.Configure( nullptr ); // protected
                ...
                fakeImmunityMal.Configure( nullptr ); // protected
...
static PyMethodDef MalariaIndividualMethods[] =
{
     ...
     {"should_infect", shouldInfect<Kernel::IndividualHumanMalaria>, METH_VARARGS, "Ask intrahost module if transmission should occur."},
     {"get_individual_for_iv", getIndividual<Kernel::IndividualHumanMalaria>, METH_VARARGS, "Get PyCapsule pointer to pass to intervention."},
...
static struct PyModuleDef moduledef = {
    ...
    "dtk_malaria_intrahost",
    nullptr,
    0,
    MalariaIndividualMethods,
    nullptr,
    nullptr,
    nullptr,
    nullptr
...
PyMODINIT_FUNC
PyInit_dtk_malaria_intrahost(void)
{
