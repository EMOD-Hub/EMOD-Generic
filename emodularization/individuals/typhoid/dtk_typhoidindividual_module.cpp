...
std::map< int, Kernel::IndividualHumanTyphoid * > population;
...
static Kernel::IndividualHumanTyphoid* initInd( int sex, float age, float mcw )
{
    person = Kernel::IndividualHumanTyphoid::CreateHuman( &node, (*individualHumanSuidGenerator)(), mcw, age, sex );
    if( configStubJson == nullptr )
    {
        setConfigJson();
        ...
        typ_infection_config_obj.Configure( configStubJson );
...
create(PyObject* self, PyObject* args)
{
    ...
    catch( const std::exception& exc )
    {
        ...
        PyErr_SetString( PyExc_RuntimeError, "Exception creating individual. Perhaps ti.json file was not found or not configured properly." );
        return NULL;
    }
}
...
getInfectiousness(PyObject* self, PyObject* args)
{
    ...
    float infectivity = population[ id ]->GetInfectiousness();
    ...
    class Simulation
    {
        public:
            ...
            Simulation()
            {
                ...
                Kernel::IndividualHumanTyphoidConfig adam; // Typhoid doesn't have anything to configure
...
static struct PyModuleDef moduledef = {
    ...
    "dtk_typhoid_intrahost",
    nullptr,
    0,
    TyphoidIndividualMethods,
    nullptr,
    nullptr,
    nullptr,
    nullptr
...
PyMODINIT_FUNC
PyInit_dtk_typhoid_intrahost(void)
{
